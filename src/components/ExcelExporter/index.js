...
export const ExcelExporter = ({data,result,fileName}) => {
    ...
    if (data && data.length < 25) {
      ...
      if (window.confirm("Warning: The sample size is below 25. Please reload the site and enter data with a sample size of at least 25. Would you like to reload the site?")) {
